...
function formatNumber(n) {
  ...
  // Ajustar la posición del cursor según el número de espacios insertados
  var spaces = formatted.substring(0, position).match(/ /g) || [];
  position += spaces.length;
  // Establecer la posición del cursor usando setSelectionRange
